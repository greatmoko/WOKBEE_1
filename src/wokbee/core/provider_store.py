...
from wokbee.core.provider import (
...
class ProviderStore:
    ...
    def __init__(self, config_path: str | None = None):
        if config_path:
            ...
            self._path = Path.home() / ".wokbee" / "providers.json"
    ...
    def _default_settings(self, provider_id: str) -> ProviderSettings:
        ...
        if b:
            return ProviderSettings(
                api_host=b.api_host,
                models=[ProviderModel.from_def(m, enabled=False) for m in b.models],
            )
        return ProviderSettings()
