...
from wokbee.core.provider_store import ProviderStore, ProviderSettings, ProviderModel
from wokbee.core.provider import get_builtin
...
class ProviderSettingsWorkspace(QWidget):
    ...
    def _build(self):
        ...
        reset_btn = QPushButton("恢复默认 Host/模型")
    ...
    def _on_reset(self):
        ...
        _tip(self, self.theme, "已恢复默认 Host 与模型清单（保留 API Key，模型默认不勾选）")
