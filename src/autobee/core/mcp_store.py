...
class McpStore:
    def __init__(self, config: Config | None = None):
        ...
        if self._config.get("autobee.mcp_servers") is None:
            self._config.set("autobee.mcp_servers", [])
            self._config.save()

    def list_servers(self) -> list[McpServerConfig]:
        raw = self._config.get("autobee.mcp_servers") or []
    ...
    def save_all(self, servers: list[McpServerConfig]) -> None:
        self._config.set("autobee.mcp_servers", [s.to_dict() for s in servers])
        self._config.save()
